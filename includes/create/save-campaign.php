...
<?php 
	...
	else
	{
		...
		{
			show_error(_('Unable to create campaign'), '<p>'._('Please ensure you have granted FULL privileges to your MySQL user for your database.').'</p><p>Or check <a href="http://anonym.to/https://sendy.co/troubleshooting#403-forbidden-error-when-clicking-save-and-next">http://anonym.to/https://sendy.co/troubleshooting#403-forbidden-error-when-clicking-save-and-next</a> as you may have "mod_security" enabled on your server.</p>');
			exit;
		}
	}
?>