		...
		<script type="text/javascript" src="<?php echo get_app_info('path');?>/js/main.js?2"></script>
		 <STYLE type="text/css">
			@font-face {
			  ...
			  font-style: normal;
			  font-weight: 400;
			  src: local('Roboto'), local('Roboto-Regular'), local('/Content/fonts/CWB0XYA8bzo0kSThX0UTuA.woff2) format('woff2'), local('/Content/fonts/2UX7WLTfW3W8TclTUvlFyQ.woff) format('woff');
			}
			@font-face {
			  font-family: 'Roboto';
			  font-style: normal;
			  font-weight: 700;
			  src: local('Roboto Bold'), local('Roboto-Bold'), local('/Content/fonts/d-6IYplOFocCacKzxwXSOFtXRa8TVwTICgirnJhmVJw.woff2) format('woff2'), local('/Content/fonts/d-6IYplOFocCacKzxwXSOD8E0i7KZn-EPnyo3HZu7kw.woff) format('woff');
			}
			@font-face {
			  font-family: 'Roboto';
			  font-style: italic;
			  font-weight: 400;
			  src: local('Roboto Italic'), local('Roboto-Italic'), local('/Content/fonts/vPcynSL0qHq_6dX7lKVByfesZW2xOQ-xsNqO47m55DA.woff2) format('woff2'), local('/Content/fonts/1pO9eUAp8pSF8VnRTP3xnvesZW2xOQ-xsNqO47m55DA.woff) format('woff');
			}
			@font-face {
			  font-family: 'Roboto';
			  font-style: italic;
			  font-weight: 700;
			  src: local('Roboto Bold Italic'), local('Roboto-BoldItalic'), local('/Content/fonts/t6Nd4cfPRhZP44Q5QAjcC44P5ICox8Kq3LLUNMylGO4.woff2) format('woff2'), local('/Content/fonts/t6Nd4cfPRhZP44Q5QAjcC4bN6UDyHWBl620a-IRfuBk.woff) format('woff');
			}
		</STYLE>
		...
		<div class="navbar navbar-fixed-top">
	      ...
	      <div class="navbar-inner">
	        <div class="container-fluid">
	          ...
	          <a class="brand" href="<?php echo get_app_info('path');?>/"><img src="<?php echo get_app_info('path');?>/img/sendy-avatar.png" title="" class="main-gravatar" onerror="this.src='<?php echo get_app_info('path');?>/img/sendy-avatar.png'"/><?php echo get_app_info('company');?></a>
	          <?php else:?>
	          <?php 
		          ...
		          if($logo_filename=='') $logo_image = get_app_info('path').'/img/sendy-avatar.png';
