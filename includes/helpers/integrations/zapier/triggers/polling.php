...
<?php 	
	...
	if($event=='new_user_subscribed' || $event=='new_user_unsubscribed')
	{
		...
		else
		{
			...
			{
				header('HTTP/ 400 No subscribers found in your list. Please add at least one subscriber in your list.');
				echo '{"message":"No subscribers found in your list. Please add at least one subscriber in your list."}';
			}
			else
			{
				header('HTTP/ 400 No subscribers found in your list marked as unsubscribed. Please add at least one subscriber in your list marked as unsubscribed.');
	...
	else if($event=='new_campaign_sent')
	{
		...
		{
			header('HTTP/ 400 No campaigns found in your brand. Please have at least one sent campaign in your brand.');
