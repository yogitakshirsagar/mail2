...
-->
    ...
    <div class="modal-body">
	    <p>Your password has been reset, a password reset email has been sent to your email address. Please check your inbox as well as your spam folder for the email. <br/><br/> If you don't receive the password reset email, please <a href="http://anonym.to/https://sendy.co/troubleshooting#forgot-password" target="_blank" style="text-decoration: underline;">see this troubleshooting tip</a>.</p>
    </div>
