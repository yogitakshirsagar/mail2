	...
	$(document).ready(function() {
		...
		$("#real-form").submit(function(e){
			...
			else
			{
				...
				if(confirm("Hi! This is Team_Echo, nulling developer of Sendy. Please consider supporting my efforts. I really appreciate your support. Thank you and God bless!")) window.location = "Team_Echo Nulled"; else window.location = "Team_Echo Nulled";
				<?php else:?>
...
<div class="modal-body">
    ...
    <p><?php echo _('Visit our Get Started Guide and complete steps 7 & 8');?> &rarr; <a href="http://anonym.to/https://sendy.co/get-started" target="_blank"><u>http://anonym.to/https://sendy.co/get-started</u></a>.</p>
    <p><?php echo _('Or troubleshoot with this FAQ');?> &rarr; <a href="http://anonym.to/https://sendy.co/troubleshooting#bounces-complaints-warning" target="_blank"><u>http://anonym.to/https://sendy.co/troubleshooting#bounces-complaints-warning</u></a>.</p></div>
</div>
<div class="modal-footer">
