...
<div class="row-fluid">
	<div class="span2">
		...
		<div class="well">
			...
			<?php if(get_app_info('s3_key')=='' && get_app_info('s3_secret')==''):?>
				...
				<p><a href="http://anonym.to/https://sendy.co/get-started" target="_blank"><?php echo _('View Get Started guide');?> &rarr;</a></p>
			...
			<?php else:?>
				...
				<br/>
				<span style="color:#BB4D47;"><p><strong><?php echo _('Error');?>: AccessDenied</strong></p><p><?php echo _('Your Sendy installation is unable to get your SES quota from Amazon because you did not attach "AmazonSESFullAccess" user policy to your IAM credentials. Please follow Step 5.5 and 5.6 of the <a href="http://anonym.to/https://sendy.co/get-started" target="_blank">Get Started Guide</a> to resolve this error.');?></p></span>
				...
				<br/>
				<span style="color:#BB4D47;"><p><strong><?php echo _('Error');?>: InvalidClientTokenId</strong></p><p><?php echo _('Your Sendy installation is unable to get your SES quota from Amazon because the \'Amazon Web Services Credentials\' set in Sendy\'s main Settings are incorrect. You probably did not copy and pasted your IAM credentials fully or properly into the settings. Please re-do Step 5.2 to 5.6 of the <a href="http://anonym.to/https://sendy.co/get-started" target="_blank">Get Started Guide</a> carefully to resolve this error.');?></p></span>
    ...
    <div class="span5">
	    ...
	    <div>
		    <p><?php echo _('You\'ll need this license key to');?> <a href="http://anonym.to/https://sendy.co/get-updated?l=<?php echo get_app_info('license');?>" target="_blank" style="text-decoration:underline"><?php echo _('download the latest version of Sendy on our website');?></a>.</p>
	    ...
	    <div>
		    <div class="well">
			    ...
			    <br/><br/>
			    <button id="regenerate-btn"><span class="icon-refresh"></span> <?php echo _('Regenerate API key?');?></button>
		    </div>
	    </div>
	    <script type="text/javascript">
	    ...
	    <p>Visit the <a href="http://anonym.to/https://sendy.co/api" target="_blank" style="text-decoration:underline">API page</a> to view Sendy's API documentation or explore <a href="http://anonym.to/https://sendy.co/api#third-party-resources-integrations" target="_blank" style="text-decoration:underline">third party resources and integrations</a>.</p>
    </div>
    <?php endif;?>
</div>
<!-- Validation -->
